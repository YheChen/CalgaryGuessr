 ...
 *     called from several components and @react-google-maps/api throws when two
 *     loads request different options, so one library addition has to be
 ...
 * opposite side of the planet. Every location here is in Calgary, so that
 * cannot arise, but do not lift this into a global context without fixing it.
 */
