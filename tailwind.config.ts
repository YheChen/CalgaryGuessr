  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        calgary: {
          red: "hsl(var(--calgary-red))",
          gold: "hsl(var(--calgary-gold))",
          sky: "hsl(var(--calgary-sky))",
          charcoal: "hsl(var(--calgary-charcoal))",
        },
        medal: {
      ...
      boxShadow: {
        soft: "0 1px 2px hsl(20 30% 10% / 0.04), 0 8px 24px -12px hsl(20 30% 10% / 0.18)",
        elevated:
          "0 4px 12px -4px hsl(20 30% 10% / 0.12), 0 16px 40px -16px hsl(20 30% 10% / 0.28)",
