  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-4 top-4 flex items-center justify-between">
        <span className="rounded-full bg-black/45 px-3 py-1.5 text-xs font-semibold text-white ring-1 ring-white/15 backdrop-blur-md">
          Round 2 / 5
        </span>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-black/45 px-3 py-1.5 text-xs font-semibold text-white ring-1 ring-white/15 backdrop-blur-md">
          <TowerGlyph className="size-3.5 text-calgary-gold" />
      ...
      <div className="absolute bottom-4 left-4">
        <span className="inline-flex items-center gap-1.5 rounded-full bg-black/45 px-3 py-1.5 text-xs font-semibold text-white ring-1 ring-white/15 backdrop-blur-md">
          <Clock className="size-3.5 text-calgary-gold" />
      ...
      <div className="absolute bottom-4 right-4 w-[44%] max-w-[220px]">
        <div className="overflow-hidden rounded-xl bg-card/95 shadow-elevated ring-1 ring-border/60">
          <div className="relative h-24 bg-secondary/60 bg-map-grid-fine">
            <span className="absolute left-1/2 top-1/2 grid size-6 -translate-x-1/2 -translate-y-1/2 animate-pulse-ring place-items-center rounded-full bg-calgary-red text-white shadow-md">
