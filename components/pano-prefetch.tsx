...
export function PanoPrefetch({ panoId }: { panoId: string }) {
  ...
  return (
    ...
    // When that happens, this 256px prefetch surface becomes 256px of blank
    // space above the round results on every round that has a next round to
    // warm. Keeping the positioning on an outer wrapper that Maps never touches
    // makes that impossible, and matches what GamePanorama already does.
    <div
      aria-hidden="true"
