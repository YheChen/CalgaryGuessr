...
const FEATURES = [
  {
    ...
    description:
      "Authentic 360° panoramas pulled straight from Calgary's streets. Pan, zoom, and explore for clues.",
  },
  {
    icon: Crosshair,
  ...
  {
    icon: Target,
    title: "Scored on distance",
    description:
      "Full marks inside 100 m, about half for the right community, and a steep drop-off after that.",
  },
] as const;
...
const STEPS = [
  ...
  {
    title: "Read the city",
    description: "Spot landmarks, the +15 network, signage, and architecture.",
  },
  {
    title: "Drop your pin",
    ...
    <>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-16">
          <div className="animate-fade-up">
            ...
            <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Drop into a random Calgary street, read the signs, skyline, and
              storefronts, then pin your best guess. Five rounds, one city, pure
              local knowledge.
            </p>

            {/* flex-wrap is load bearing, not tidiness: a non-wrapping row of
                buttons cannot shrink below its combined min-content width, and a
                grid item that cannot shrink pushes the whole page sideways on
                tablet widths. Wrapping drops the min-content to one button. */}
          ...
          <div className="relative animate-fade-up delay-150">
            <div
              // inset-x-0, not a negative horizontal bleed: the container's
              // padding is 20px, and any bleed wider than that makes the page
              // scroll sideways. blur-3xl already spreads the halo well past
              // this box, so the box itself does not need to be oversized.
      ...
      <section className="container pb-20 sm:pb-28">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
          ...
          <Reveal delay={90}>
            <StatCard icon={Target} label="Max points per round" value={5000} />
          </Reveal>
          <Reveal delay={180}>
            <StatCard
              icon={Timer}
        ...
        <Reveal>
          <div className="surface-card relative overflow-hidden rounded-3xl px-6 py-14 text-center sm:px-12 sm:py-20">
            ...
            <div
              ...
              aria-hidden="true"
            >
              <Skyline className="h-36 sm:h-52" />
            </div>
